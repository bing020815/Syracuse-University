...
```{r RandomForest Prep & Execution, message=FALSE, warning=FALSE, paged.print=FALSE}
#Remove Size
...
svmOutput <- ksvm(Installs~., data = trainData, kernel = "rbfdot", kpar="automatic", C=5, cross=3, prob.model=TRUE)
svmOutput
